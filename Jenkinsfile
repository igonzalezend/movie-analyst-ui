                    ...
                    steps{
                        dir('/var/lib/jenkins/workspace') {
                            ...
                            sh '''
                                ...
                                ssh ubuntu@10.0.4.175 "sudo chown ubuntu:ubuntu /home/ubuntu/.pm2/rpc.sock /home/ubuntu/.pm2/pub.sock ; pm2 stop all ; pm2 start /RampUp_movie-analyst-ui/ecosystem.config.js"
                            '''
                        }                
                    }
                }
                    ...
                    steps{
                        dir('/var/lib/jenkins/workspace') {
                            ...
                            sh '''
                                ...
                                ssh ubuntu@10.0.5.243 "sudo chown ubuntu:ubuntu /home/ubuntu/.pm2/rpc.sock /home/ubuntu/.pm2/pub.sock ; pm2 stop all ; pm2 start /RampUp_movie-analyst-ui/ecosystem.config.js"
                            '''
                        }
                    }
                }
